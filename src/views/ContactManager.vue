    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                ...
                <p class="fst-italic">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis temporibus
                    eveniet officiis. Magnam, labore porro! Ipsa aut facere sed blanditiis! Ab id exercitationem
                    corrupti totam delectus iure error est voluptatibus?</p>
                <form>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-1 d-flex flex-column align-items-center ">
                                ...
                                <button class="btn btn-danger my-1" @click="deleteRecord(contact.id)">
...
export default {
    ...
    methods: {
        deleteRecord : async function (contactId) {
            try {
                this.loading = true;
