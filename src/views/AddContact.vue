    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                ...
                <p class="fst-italic">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum non dignissimos
                    inventore maxime officia, doloribus temporibus magnam tempora, necessitatibus at earum voluptate
                    fugit ipsam magni amet sapiente aliquam repellendus dicta!</p>
            </div>
        </div>
    </div>
    <div class="container">
